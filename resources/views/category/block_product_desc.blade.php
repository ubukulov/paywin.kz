            ...
            <div class="max-w-3xl space-y-4">
                <div class="p-4 bg-orange-50/40 border border-orange-100 rounded-2xl flex gap-3.5 items-start">
                    ...
                    <div class="text-sm">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            ...
                            система автоматически выберет один из доступных подарков партнера. Вы увидите выигранный приз сразу на странице завершения оплаты.
                        </p>
                    </div>
                </div>
                ...
                <div class="p-4 bg-gray-50 border border-gray-100 rounded-2xl flex gap-3.5 items-start">
                    ...
                    <div class="text-sm text-gray-500 leading-relaxed">
                        ...
                        <p>Все выигранные бонусы, промокоды и билеты мгновенно привязываются к вашему профилю и доступны в личном кабинете в разделе «Мои призы». Призы не подлежат обмену на денежный эквивалент. При возврате товара начисленные за него бонусы и шансы аннулируются.</p>
                    </div>
                </div>
            </div>
        </div>
