...
<head>
    ...
    <meta property="og:title" content="@yield('og_title', 'Paywin.kz — Выигрывай при каждой покупке')">
    <meta property="og:description" content="@yield('og_description', 'Покупай товары и получай гарантированные призы!')">
    <meta property="og:image" content="@yield('og_image', asset('img/default-preview.jpg'))">

    <!-- Теги для Telegram / Twitter -->
